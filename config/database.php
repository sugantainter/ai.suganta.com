    ...
    */
    ...
    'connections' => [
        ...
        'ai_mysql' => [
            ...
            'database' => env('AI_DB_DATABASE', 'ai_suganta'),
            ...
            'charset' => env('AI_DB_CHARSET', env('DB_CHARSET', 'utf8mb4')),
            'collation' => env('AI_DB_COLLATION', env('DB_COLLATION', 'utf8mb4_unicode_ci')),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
